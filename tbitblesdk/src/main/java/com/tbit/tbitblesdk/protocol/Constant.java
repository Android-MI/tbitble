...
public class Constant {
    ...
    public static final int REQUEST_IGNORE = 255;
    public static final int REQUEST_CONNECT = 128;
    public static final int REQUEST_SET_DEFENCE = 129;
    //    public static final int REQUEST_CANCEL_DEFENCE = 130;
    public static final int REQUEST_FIND_CAR = 131;
    public static final int REQUEST_HOME_MODE = 132;
    public static final int REQUEST_SILENCE = 133;
    public static final int REQUEST_FAST_START = 134;
    public static final int REQUEST_CONTROL = 135;
    public static final int REQUEST_AUTO_DEFENCE = 136;
    public static final int REQUEST_RSSI = 137;
    public static final int REQUEST_SENSIBILITY = 138;
    public static final int REQUEST_TERMINAL_VOLTAGE = 139;
    public static final int REQUEST_WHEEL_RADIUS = 140;
    public static final int REQUEST_QUERY_VOLTAGE = 141;
    public static final int REQUEST_QUERY_WHEEL_TERN = 142;
    public static final int REQUEST_QUERY_SPEED = 143;
    public static final int REQUEST_RESTART = 144;
    public static final int REQUEST_RESET = 145;
    public static final int REQUEST_UPDATE = 146;
    public static final int REQUEST_QUERY_TEMPERATURE = 147;
    public static final int REQUEST_QUERY_TESTED = 148;
    public static final int REQUEST_HEART_BEAT = 149;
    public static final int REQUEST_MILEAGE_CALIBRATION = 150;
    public static final int REQUEST_LOG = 151;
    public static final int REQUEST_UNLOCK = 152;
    public static final int REQUEST_LOCK = 153;
    public static final int REQUEST_COMMON = 154;
    public static final int REQUEST_REMOTE = 155;
    public static final int REQUEST_OTA = 156;
    public static final int REQUEST_OTA_CONNECT = 157;
